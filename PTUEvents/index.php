        ...
        <div class = "content"><!--body content holder-->
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <p><!--content-->
                            UNLEASH INNOVATIONS : ELEVATE YOUR PRESENCE AT THE TECH EVENTS OF THE YEAR!
                            </p>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6"><!--image holder with 6 grid columns-->
                            <img src="images/pub.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#003300 ; font-size:38px ;"><strong><u>Gaming Events</u></strong></h1><!--title-->
                            <p><!--content-->
                            LEVEL UP YOUR EXPERIENCE : DIVE INTO THE ULTIMATE GAMMING ADVENTURE!
                            </p>
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <p><!--content-->
                                STEP INTO THE SPOTLIGHT AND SHINE ON THE STAGE WITH US!
                            </p>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6"><!--image holder with 6 grid columns-->
                            <img src="images/off.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#003300 ; font-size:38px ;"><strong><u>Off-Stage Events</u></strong></h1><!--title-->
                            <p><!--content-->
                            BEYOND THE SPOTLIGHT : JOIN US IN UNFORGETTABLE OFF-STAGE EXPERIENCES!
                            </p>
